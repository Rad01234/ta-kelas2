                    ...
                    <div class="">
                        <form class="" action="" method="POST">
                            <div class="input-group">
                                ...
                                <a href="history_kasir.php" class="btn btn-danger">
                                    ...
                                    <tr>
                                        ...
                                        <td class='text-center p-0'>
                                            <a class='btn btn-danger text-white'
                                                href='../transaksi/hapus_transaksi.php?id_transaksi=<?= $row_list['id_transaksi'] ?>'
                                                id="hapus<?= $row_list['id_transaksi'] ?>">
                                                <i class='bx bx-trash'></i>
                                            </a>
                                            <a class='btn btn-info text-white'
                                                href='../transaksi/transaksi_selesai.php?id_trx=<?= $row_list['id_transaksi'] ?>'>
                ...
                document.getElementById('hapus<?= $row_list['id_transaksi'] ?>').addEventListener('click', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../transaksi/hapus_transaksi.php?id_transaksi=' + <?= $row_list['id_transaksi'] ?>;
                        }
                    });
                });
            <?php endwhile; ?>
