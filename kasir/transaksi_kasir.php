...
<body>
        ...
        <div class="container-fluid mt-4">
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="../transaksi/keranjang_act.php" method="POST" class="form-inline">
                    ...
                    <div class="card mt-4">
                        <div class="card-body">
                            <form action="../transaksi/keranjang_update.php" method="POST">
                                            ...
                                            <?php if (isset($_SESSION['cart']) && is_array($_SESSION['cart']) && count($_SESSION['cart']) > 0) { ?>
                                                <?php foreach ($_SESSION['cart'] as $key => $value) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="../transaksi/keranjang_hapus.php?id=<?= $value['id'] ?>"
                                ...
                                <div class="mt-3">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="../transaksi/keranjang_reset.php" class="btn btn-danger">Reset</a>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        document.querySelector("form[action='../transaksi/keranjang_act.php']").addEventListener("submit", function (e) {
    ...
    <script>
        document.querySelector("form[action='../transaksi/proses_transaksi.php']").addEventListener("submit", function (e) {
