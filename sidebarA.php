...
<body>
    <div class="sidebar bg-success bg-gradient">
        ...
        <ul class="nav_list">
            <li class="<?= $currentPage === 'index_admin.php' ? 'nav_now' : '' ?>">
                <a href="<?= $currentPage === 'index_admin.php' ? '#' : '../admin/index_admin.php' ?>"
                    data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Dashboard">
                    <i class='bx bx-grid-alt'></i>
                    <span class="links_name">Dashboard</span>
                </a>
            <li class="<?= $currentPage === 'pegawai.php' ? 'nav_now' : '' ?>">
                <a href="<?= $currentPage === 'pegawai.php' ? '#' : '../manage/pegawai.php' ?>" data-bs-toggle="tooltip"
                    data-bs-placement="right" data-bs-title="Pegawai">
                    <i class='bx bx-user'></i>
                    <span class="links_name">Pegawai</span>
                </a>
            </li>
            <li class="<?= $currentPage === 'barang.php' ? 'nav_now' : '' ?>">
                <a href="<?= $currentPage === 'barang.php' ? '#' : '../barang/barang.php' ?>" data-bs-toggle="tooltip"
                    data-bs-placement="right" data-bs-title="Barang">
                    <i class='bx bx-package'></i>
                    <span class="links_name">Barang</span>
                </a>
            </li>
            <li class="<?= $currentPage === 'kategori.php' ? 'nav_now' : '' ?>">
                <a href="<?= $currentPage === 'kategori.php' ? '#' : '../kategori/kategori.php' ?>"
                    data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Kategori">
                    <i class='bx bx-clipboard'></i>
                    <span class="links_name">Kategori</span>
                </a>
            </li>
            <li class="<?= $currentPage === 'transaksi.php' ? 'nav_now' : '' ?>">
                <a href="<?= $currentPage === 'transaksi.php' ? '#' : '../transaksi/transaksi.php' ?>"
                    data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Transaksi">
                    <i class='bx bx-wallet'></i>
                    <span class="links_name">Transaksi</span>
                </a>
            </li>
            <li class="<?= $currentPage === 'history.php' ? 'nav_now' : '' ?>">
                <a href="<?= $currentPage === 'history.php' ? '#' : '../transaksi/history.php' ?>"
        ...
        <div class="profile_content bg-info">
            <div class="profile">
