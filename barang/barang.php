...
<body>
                        ...
                        <table class="table table-bordered align-middle table-hover">
                            ...
                            <tbody>
                                ...
                                if (isset($_POST['bcari'])) {
                                    ...
                                    WHERE barang.id_barang LIKE '%$keyword%' OR barang.nama_barang LIKE '%$keyword%' OR kategori.nama_kategori LIKE '%$keyword%'";
                                } else {
                                    $query = "SELECT barang.*, kategori.* 
                                    FROM barang 
                                    JOIN kategori ON barang.id_kategori = kategori.id_kategori";
                                    ...
                                    <tr>
                                        ...
                                        <td class='text-center p-0'>
                                            ...
                                            <a class='btn btn-warning text-decoration-none text-white'
                                                href='edit_barang.php?id_barang=<?= $row_list['id_barang'] ?>'>
                                                <i class='bx bx-edit'></i>
                                            </a>
                                            <a class='btn btn-danger text-decoration-none text-white' href='#'
                                                id="hapus<?= $row_list['id_barang'] ?>">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            while ($row_list = mysqli_fetch_array($result)):
                ?>
                document.getElementById('hapus<?= $row_list['id_barang'] ?>').addEventListener('click', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = 'hapus_barang.php?id_barang=' + <?= $row_list['id_barang'] ?>;
                        }
                    });
                });
            <?php endwhile; ?>
