...
<body>
    <div class="sidebar bg-danger bg-gradient">
        ...
        <ul class="nav_list">
            <li class="<?= $currentPage === 'index_kasir.php' ? 'nav_now' : '' ?>">
                <a href="<?= $currentPage === 'index_kasir.php' ? '#' : '../kasir/index_kasir.php' ?>" data-bs-toggle="tooltip" data-bs-placement="right"
                    data-bs-title="Kasir">
                    <i class='bx bx-grid-alt'></i>
                    <span class="links_name">Dashboard</span>
                </a>
            </li>
            <li class="<?= $currentPage === 'transaksi_kasir.php' ? 'nav_now' : '' ?>">
                <a href="<?= $currentPage === 'transaksi_kasir.php' ? '#' : '../kasir/transaksi_kasir.php' ?>" data-bs-toggle="tooltip" data-bs-placement="right"
                    data-bs-title="Transaksi">
                    <i class='bx bx-wallet'></i>
                    <span class="links_name">Transaksi</span>
                </a>
            </li>
            <li class="<?= $currentPage === 'history_kasir.php' ? 'nav_now' : '' ?>">
                <a href="<?= $currentPage === 'history_kasir.php' ? '#' : '../kasir/history_kasir.php' ?>" data-bs-toggle="tooltip" data-bs-placement="right"
